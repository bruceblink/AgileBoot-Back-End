...
INSERT INTO sys_dict_type (dict_name, dict_type, status, remark, creator_id, updater_id, create_time, update_time, deleted)
...
FROM (
    ...
    UNION ALL SELECT 'sysUser.sex', '男', '1', 1, 0, '', '性别男'
    UNION ALL SELECT 'sysUser.sex', '女', '2', 2, 0, '', '性别女'
    UNION ALL SELECT 'sysUser.sex', '未知', '0', 3, 0, '', '性别未知'
