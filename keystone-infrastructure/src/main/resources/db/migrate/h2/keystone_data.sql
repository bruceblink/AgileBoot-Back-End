...
VALUES (1, 'common.yesOrNo', '是', '1', 1, 0, '', 1, '是', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
       ...
       (5, 'sysUser.sex', '女', '0', 1, 0, '', 1, '性别女', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
       (6, 'sysUser.sex', '男', '1', 2, 0, '', 1, '性别男', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
       (7, 'sysUser.sex', '未知', '2', 3, 0, '', 1, '性别未知', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
