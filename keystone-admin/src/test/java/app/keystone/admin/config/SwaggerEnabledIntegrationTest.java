...
class SwaggerEnabledIntegrationTest {
    ...
    @Test
    void apiDocsShouldBeAccessibleWithoutAuthenticationWhenEnabled() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
            .andExpect(status().isOk());
    }

    @Test
    void swaggerUiShouldBeAccessibleWithoutAuthenticationWhenEnabled() throws Exception {
